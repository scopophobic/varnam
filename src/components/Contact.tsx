              ...
              <div className="flex items-center justify-center gap-4">
                {socialLinks.map((link) => (
                  <a
                    ...
                    className="flex h-12 w-12 items-center justify-center rounded-xl border border-charcoal/15 bg-white text-charcoal shadow-sm transition-all duration-300 hover:bg-charcoal hover:text-white hover:border-charcoal hover:scale-105 active:scale-95 cursor-pointer"
